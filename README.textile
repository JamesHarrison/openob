...
To install dependencies on an Ubuntu box you can run the following:
    ...
    sudo apt-get install python-gst0.10 python-serial python-redis gstreamer0.10-plugins-base gstreamer0.10-plugins-bad \
      gstreamer0.10-plugins-bad-multiverse gstreamer0.10-plugins-good gstreamer0.10-plugins-ugly gstreamer0.10-alsa \
      gstreamer0.10-ffmpeg gstreamer0.10-tools python-gobject python-gobject-2 gstreamer0.10-alsa python-yaml
